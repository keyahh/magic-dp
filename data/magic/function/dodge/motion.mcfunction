...
execute unless block ~ ~-0.2 ~ #magic:passable run scoreboard players set $strength player_motion.api.launch 15000
execute if block ~ ~-0.2 ~ #magic:passable run scoreboard players set $strength player_motion.api.launch 6000
