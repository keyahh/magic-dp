...
#block collision
execute unless block ~ ~ ~ #magic:passable run function magic:spells/24/fizzle
...
#recurse
execute if score #magicRange slowcast.itt matches 1.. positioned ^ ^ ^0.25 run function magic:spells/24/slowcast