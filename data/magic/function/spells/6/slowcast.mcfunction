...
execute positioned ~-0.1 ~-0.1 ~-0.1 as @e[distance=..5,type=#magic:targets,predicate=!magic:match_id,dx=0] positioned ~-0.8 ~-0.8 ~-0.8 if entity @s[dx=0] unless score @s magic.iframe matches 1.. at @s run function magic:spells/6/hit_entity
