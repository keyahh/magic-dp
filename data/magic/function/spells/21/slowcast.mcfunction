...
execute positioned ~-0.45 ~-0.45 ~-0.45 as @e[type=#magic:targets,predicate=!magic:match_id,distance=..6,dx=0] positioned ~-0.1 ~-0.1 ~-0.1 if entity @s[dx=0] as @n[type=marker,tag=thisSpell,distance=..6] at @s run function magic:spells/21/fizzle
