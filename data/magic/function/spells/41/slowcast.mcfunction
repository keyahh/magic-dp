...
execute positioned ~-0.25 ~-0.25 ~-0.25 as @e[type=#magic:targets,predicate=!magic:match_id,distance=..5,dx=0] positioned ~-0.5 ~-0.5 ~-0.5 if entity @s[dx=0] unless score @s magic.iframe matches 1.. as @n[type=marker,tag=thisSpell] positioned ~0.75 ~0.75 ~0.75 run function magic:spells/41/damage
