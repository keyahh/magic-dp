...
execute unless entity @e[distance=..20,type=#magic:priority1,predicate=!magic:match_id] anchored eyes rotated as @n[type=#magic:magic_user,predicate=magic:match_id] positioned ^ ^ ^3.5 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ~ ~ ~ ~ ~
