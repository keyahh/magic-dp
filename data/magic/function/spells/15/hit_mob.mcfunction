...
function animated_java:laceration/summon {args:{}}
execute positioned ~-1.25 ~-1.25 ~-1.25 as @e[type=#magic:targets,tag=!thisPlayer,dx=1.25,dy=1.25,dz=1.25] positioned ~1.25 ~1.25 ~1.25 run function magic:spells/15/damage
