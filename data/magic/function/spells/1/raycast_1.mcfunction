...
execute positioned ~-0.2 ~-0.2 ~-0.2 as @e[type=#magic:targets,tag=!thisPlayer,dx=0] positioned ~-0.6 ~-0.6 ~-0.6 if entity @s[dx=0] unless score @s magic.iframe matches 1.. run function magic:spells/1/damage
