...
execute positioned ~-0.3 ~-0.3 ~-0.3 as @e[distance=..5,type=#magic:targets,predicate=!magic:match_id,dx=0] positioned ~-0.4 ~-0.4 ~-0.4 if entity @s[dx=0] run function magic:spells/4/hit_mob
