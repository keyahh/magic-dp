...
execute positioned ~-1.25 ~-2.5 ~-1.25 as @e[type=#magic:targets,predicate=!magic:match_id,distance=..5,dx=1.5,dy=1.5,dz=1.5] unless score @s magic.iframe matches 1.. at @s run damage @s 20 magic:ignore_cooldown by @n[type=#magic:magic_user,tag=thisPlayer]
