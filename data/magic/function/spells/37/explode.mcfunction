...
execute positioned ~-0.75 ~-0.75 ~-0.75 as @e[type=#magic:targets,dx=0.5,dy=0.5,dz=0.5,distance=..10] unless score @s magic.iframe matches 1.. run function magic:spells/37/damage
