...
execute positioned ~-0.75 ~-0.75 ~-0.75 as @e[type=#magic:targets,dx=0.5,dy=0.5,dz=0.5,distance=..10] run damage @s 12 player_attack by @n[type=#magic:magic_user,tag=thisPlayer]
