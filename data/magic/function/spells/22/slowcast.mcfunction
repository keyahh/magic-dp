...
execute positioned ~-0.475 ~-0.475 ~-0.475 as @e[distance=..5,type=#magic:targets,predicate=!magic:match_id,dx=0] positioned ~-0.05 ~-0.05 ~-0.05 if entity @s[dx=0] run function magic:spells/22/hit_mob

execute positioned ^1 ^ ^ positioned ~-0.475 ~-0.475 ~-0.475 as @e[distance=..5,type=#magic:targets,predicate=!magic:match_id,dx=0] positioned ~-0.05 ~-0.05 ~-0.05 if entity @s[dx=0] run function magic:spells/22/hit_mob
