...
execute positioned ~-0.5 ~-1 ~-0.5 as @e[type=#magic:targets,predicate=!magic:match_id,distance=..5,dx=0,dy=0,dz=0] unless score @s magic.iframe matches 1.. as @n[type=item_display,tag=fireball,tag=thisSpell,distance=..6] at @s run return run function magic:spells/27/explode
