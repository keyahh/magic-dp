...
execute positioned ~-.5 ~ ~-.5 as @e[type=#magic:targets,predicate=!magic:match_id,dx=0,dy=1.5,dz=0] unless score @s magic.iframe matches 1.. run function magic:spells/16/damage

execute positioned ~-0.5 ~ ~-0.5 as @e[type=#magic:proj_spell,tag=projSpell,dx=0,dy=1.5,dz=0] run kill @s
