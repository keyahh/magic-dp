...
execute positioned ~-.5 ~-.5 ~-.5 as @e[type=#magic:targets,predicate=!magic:match_id,dx=0,dy=0,dz=0] unless score @s magic.iframe matches 1.. run damage @s 20 player_attack by @n[type=#magic:magic_user,predicate=magic:match_id]
