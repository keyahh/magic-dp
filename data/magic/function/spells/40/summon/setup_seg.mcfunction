...
data merge entity @s {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.75f,0f],scale:[1.5f,1.5f,1.5f]},teleport_duration:2,item_display:"head",Tags:["magic","earthWorm","wormSeg","conjuration","magicSpell"],brightness:{sky:15,block:15},item:{id:"minecraft:dirt",count:1,components:{"minecraft:item_model":"magic:worm_body"}}}
