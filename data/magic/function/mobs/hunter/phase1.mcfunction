...
#dodge
execute if entity @s[tag=!inAtk,tag=!inDodge] if entity @p[gamemode=!creative,gamemode=!spectator,distance=..20,scores={magic.castTime=1..}] run function magic:mobs/hunter/dodge/dodge