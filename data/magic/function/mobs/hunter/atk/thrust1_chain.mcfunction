...
execute if score #rng magic.temp matches 1 on passengers if entity @s[tag=aj.mage_hunter.root] run return run function animated_java:mage_hunter/animations/slash/tween {to_frame:18,duration:8}
