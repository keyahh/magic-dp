...
execute if score #rng magic.temp matches 4 run scoreboard players set @s magic.spellID 34
execute if score #rng magic.temp matches 5 run scoreboard players set @s magic.spellID 3
...
execute if score #rng magic.temp matches 9 run scoreboard players set @s magic.spellID 2
