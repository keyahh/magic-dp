...
execute if score #rng magic.temp matches 5..8 as @n[type=item_display,tag=aj.lich.root,predicate=magic:match_id] run return run function animated_java:lich/animations/swing2/play
...
execute if score #rng magic.temp matches 11 as @n[type=item_display,tag=aj.lich.root,predicate=magic:match_id] run return run function animated_java:lich/animations/delayed_bomb/play
...
execute if score #rng magic.temp matches 15..18 run function magic:mobs/lich/dodge/dodge
