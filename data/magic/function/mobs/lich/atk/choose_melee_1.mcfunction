...
execute if score #rng magic.temp matches 1..3 on passengers if entity @s[tag=aj.lich.root] run return run function animated_java:lich/animations/swing1/play
execute if score #rng magic.temp matches 4..8 on passengers if entity @s[tag=aj.lich.root] run return run function animated_java:lich/animations/swing2/play
execute if score #rng magic.temp matches 9..10 on passengers if entity @s[tag=aj.lich.root] run return run function animated_java:lich/animations/slam/play
execute if score #rng magic.temp matches 11..12 on passengers if entity @s[tag=aj.lich.root] run return run function animated_java:lich/animations/delayed_bomb/play
execute if score #rng magic.temp matches 13..15 on passengers if entity @s[tag=aj.lich.root] run return run function animated_java:lich/animations/ground_cutter/play
execute if score #rng magic.temp matches 16..20 on passengers if entity @s[tag=aj.lich.root] run return run function animated_java:lich/animations/shotgun/play
