...
execute if score #rng magic.temp matches 10..12 on passengers if entity @s[tag=aj.lich.root] run return run function animated_java:lich/animations/delayed_bomb/play
execute if score #rng magic.temp matches 13..17 on passengers if entity @s[tag=aj.lich.root] run return run function animated_java:lich/animations/dash/play
...
#execute if score #rng magic.temp matches 10..12 as @n[type=item_display,tag=aj.lich.root,predicate=magic:match_id] run return run function animated_java:lich/animations/delayed_bomb/play
#execute if score #rng magic.temp matches 13..17 as @n[type=item_display,tag=aj.lich.root,predicate=magic:match_id] run return run function animated_java:lich/animations/dash/play
