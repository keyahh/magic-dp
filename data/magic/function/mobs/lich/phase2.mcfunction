...
execute if score @s[tag=!inAtk,tag=!inDodge] magic.atkCD matches ..0 if entity @a[gamemode=!creative,gamemode=!spectator,distance=..20] run function magic:mobs/lich/atk/choose_attack_2
