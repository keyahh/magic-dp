...
execute on passengers if entity @s[tag=aj.lich.root,tag=!aj.lich.animation.walk.playing] at @s run function animated_java:lich/animations/walk/play

execute unless predicate magic:moving run function magic:mobs/lich/walk/stop_moving
