...
$data merge entity $(bone_hair_side) {transformation: [-1f,0.0006f,-0.0003f,-0.2969f,0.0006f,1f,-0.0076f,1.9118f,0.0003f,-0.0076f,-1f,0.2534f,0f,0f,0f,1f],start_interpolation: 0,interpolation_duration: 1}
...
execute on vehicle unless entity @s[tag=aj.transforms_only] at @s run function animated_java:lich/animations/swing2/zzz/frames/55_root_commands