...
$data merge entity $(bone_beard) {transformation: [-1f,0f,0f,0f,0f,0.999f,0.0436f,1.6165f,0f,0.0436f,-0.999f,0.272f,0f,0f,0f,1f],start_interpolation: 0,interpolation_duration: 1}
...
execute on vehicle unless entity @s[tag=aj.transforms_only] at @s run function animated_java:lich/animations/pray/zzz/frames/101_root_commands