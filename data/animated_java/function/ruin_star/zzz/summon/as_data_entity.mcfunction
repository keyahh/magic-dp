...
execute on vehicle on passengers if entity @s[tag=aj.ruin_star.node.bone1] run function animated_java:global/internal/gu/convert_uuid_array_to_string
data modify entity @s data.uuids.bone_bone1 set from storage aj:uuid main.out
execute on vehicle on passengers if entity @s[tag=aj.ruin_star.node.bone] run function animated_java:global/internal/gu/convert_uuid_array_to_string
